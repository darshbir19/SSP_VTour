  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex max-w-2xl flex-col items-center gap-5 px-6 text-center">
        ...
        <p className="text-lg text-slate-200">Sham Shui Po Sensory Tour</p>
        <p className="max-w-lg text-sm text-slate-300 sm:text-base">
          Start simple: open a 2D district map, click a location pin, and hear a location-based
          soundscape while viewing that street.
        </p>
        <button
          onClick={onStart}
